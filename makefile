...
C_FLAGS += -std=c99 -W -Wall -mcpu=cortex-m3 -mfloat-abi=soft -mthumb --specs=nosys.specs -ffunction-sections \
-fdata-sections -Wl,--gc-sections -D STM32F103xB -D USE_FULL_LL_DRIVER -D USART_USE_USART1 -D USART_USE_DMA \
-D MOTION_DRIVER_TARGET_MSP430 -D MPU6050 $(INC_FLAGS) 
...
all: $(MY_C_OBJ) $(MY_ASM_OBJ) $(CORE_C_OBJ) $(CORE_ASM_OBJ) $(LIB_C_OBJ) $(LIB_ASM_OBJ)
	...
	$(LIB_ASM_OBJ) -T $(LINK_FILE) -o $(BIN_PATH)/$(TARGET).elf -lm
